...
\restrict es31BnoiGd11YeQfbTXY6UEq96qUMagdoP47eKOeehF4CqDLAe7fnvhQSx1bgtA
...
--
-- Name: log_finance_changes(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.log_finance_changes() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER FUNCTION public.log_finance_changes() OWNER TO postgres;
...
--
-- Name: attendance_device_logs; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE public.attendance_device_logs (
    ...
    punch_type character varying(10),
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP
);


ALTER TABLE public.attendance_device_logs OWNER TO postgres;

--
-- Name: attendance_device_logs_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.attendance_device_logs_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.attendance_device_logs_id_seq OWNER TO postgres;

--
-- Name: attendance_device_logs_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.attendance_device_logs_id_seq OWNED BY public.attendance_device_logs.id;
...
--
-- Name: course_schedules_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.course_schedules_id_seq OWNER TO postgres;

--
-- Name: course_schedules_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: disciplinary_actions_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.disciplinary_actions_id_seq OWNER TO postgres;

--
-- Name: disciplinary_actions_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: finance_fee_types; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.finance_fee_types OWNER TO postgres;

--
-- Name: finance_fee_types_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.finance_fee_types_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.finance_fee_types_id_seq OWNER TO postgres;

--
-- Name: finance_fee_types_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.finance_fee_types_id_seq OWNED BY public.finance_fee_types.id;


--
-- Name: finance_payment_plans; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.finance_payment_plans OWNER TO postgres;

--
-- Name: finance_payment_plans_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.finance_payment_plans_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.finance_payment_plans_id_seq OWNER TO postgres;

--
-- Name: finance_payment_plans_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.finance_payment_plans_id_seq OWNED BY public.finance_payment_plans.id;
...
ALTER TABLE public.finance_payments_id_seq OWNER TO postgres;
...
--
-- Name: finance_student_fees; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.finance_student_fees OWNER TO postgres;

--
-- Name: finance_student_fees_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.finance_student_fees_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.finance_student_fees_id_seq OWNER TO postgres;

--
-- Name: finance_student_fees_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.finance_student_fees_id_seq OWNED BY public.finance_student_fees.id;
...
--
-- Name: official_documents; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: official_documents_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.official_documents_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.official_documents_id_seq OWNER TO postgres;

--
-- Name: official_documents_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.official_documents_id_seq OWNED BY public.official_documents.id;
...
ALTER TABLE public.payroll_slips_id_seq OWNER TO postgres;
...
--
-- Name: src_classes; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.src_classes (
    id integer NOT NULL,
    name text NOT NULL,
    level text,
    specialty_id integer,
...
ALTER TABLE public.src_classes OWNER TO postgres;

--
-- Name: src_specialties; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.src_specialties (
    id integer NOT NULL,
    name text NOT NULL,
    code text,
    description text
...
ALTER TABLE public.src_specialties OWNER TO postgres;

--
-- Name: src_subjects; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.src_subjects (
    id integer NOT NULL,
    code text,
    name text NOT NULL,
    credits integer,
...
ALTER TABLE public.src_subjects OWNER TO postgres;
...
CREATE TABLE public.students (
    ...
    class_id integer,
    special_status character varying(100),
    photo text,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP
);
...
--
-- Name: attendance_device_logs id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.attendance_device_logs ALTER COLUMN id SET DEFAULT nextval('public.attendance_device_logs_id_seq'::regclass);
...
--
-- Name: course_schedules id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: disciplinary_actions id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: finance_fee_types id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.finance_fee_types ALTER COLUMN id SET DEFAULT nextval('public.finance_fee_types_id_seq'::regclass);


--
-- Name: finance_payment_plans id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.finance_payment_plans ALTER COLUMN id SET DEFAULT nextval('public.finance_payment_plans_id_seq'::regclass);
...
--
-- Name: finance_student_fees id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.finance_student_fees ALTER COLUMN id SET DEFAULT nextval('public.finance_student_fees_id_seq'::regclass);
...
--
-- Name: official_documents id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.official_documents ALTER COLUMN id SET DEFAULT nextval('public.official_documents_id_seq'::regclass);
...
--
-- Name: system_options PK_14d8c07f7e33f92c7c5ec02c397; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.system_options
    ADD CONSTRAINT "PK_14d8c07f7e33f92c7c5ec02c397" PRIMARY KEY (id);
...
--
-- Name: bulletin PK_9803a6af5584494eeb1b150fb98; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.bulletin
    ADD CONSTRAINT "PK_9803a6af5584494eeb1b150fb98" PRIMARY KEY (id);
...
--
-- Name: campuses PK_d6a06870edd505bfc2d002cb728; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.campuses
    ADD CONSTRAINT "PK_d6a06870edd505bfc2d002cb728" PRIMARY KEY (id);
...
--
-- Name: academic_years academic_years_name_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: attendance_device_logs attendance_device_logs_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.attendance_device_logs
    ADD CONSTRAINT attendance_device_logs_pkey PRIMARY KEY (id);
...
--
-- Name: bulletins bulletins_student_id_academic_year_id_semester_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.bulletins
    ADD CONSTRAINT bulletins_student_id_academic_year_id_semester_id_key UNIQUE (student_id, academic_year_id, semester_id);
...
--
-- Name: finance_fee_types finance_fee_types_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.finance_fee_types
    ADD CONSTRAINT finance_fee_types_pkey PRIMARY KEY (id);


--
-- Name: finance_payment_plans finance_payment_plans_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.finance_payment_plans
    ADD CONSTRAINT finance_payment_plans_pkey PRIMARY KEY (id);
...
--
-- Name: finance_payments finance_payments_receipt_number_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.finance_payments
    ADD CONSTRAINT finance_payments_receipt_number_key UNIQUE (receipt_number);


--
-- Name: finance_student_fees finance_student_fees_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.finance_student_fees
    ADD CONSTRAINT finance_student_fees_pkey PRIMARY KEY (id);
...
--
-- Name: grades grades_student_id_evaluation_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: official_documents official_documents_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: payroll_slips payroll_slips_staff_id_month_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.payroll_slips
    ADD CONSTRAINT payroll_slips_staff_id_month_key UNIQUE (staff_id, month);
...
--
-- Name: specialties specialties_code_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: src_classes src_classes_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.src_classes
    ADD CONSTRAINT src_classes_pkey PRIMARY KEY (id);


--
-- Name: src_specialties src_specialties_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.src_specialties
    ADD CONSTRAINT src_specialties_pkey PRIMARY KEY (id);


--
-- Name: src_subjects src_subjects_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.src_subjects
    ADD CONSTRAINT src_subjects_pkey PRIMARY KEY (id);


--
-- Name: staff staff_biometric_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.staff
    ADD CONSTRAINT staff_biometric_id_key UNIQUE (biometric_id);


--
-- Name: staff staff_matricule_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.staff
    ADD CONSTRAINT staff_matricule_key UNIQUE (matricule);
...
--
-- Name: idx_finance_student_fees; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_finance_student_fees ON public.finance_student_fees USING btree (student_id);
...
--
-- Name: idx_staff_biometric_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_staff_biometric_id ON public.staff USING btree (biometric_id);


--
-- Name: idx_students_matricule; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_students_matricule ON public.students USING btree (matricule);
...
--
-- Name: finance_student_fees audit_finance_fees; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER audit_finance_fees AFTER INSERT OR DELETE OR UPDATE ON public.finance_student_fees FOR EACH ROW EXECUTE FUNCTION public.log_finance_changes();


--
-- Name: finance_payments audit_finance_payments; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER audit_finance_payments AFTER INSERT OR DELETE OR UPDATE ON public.finance_payments FOR EACH ROW EXECUTE FUNCTION public.log_finance_changes();


--
-- Name: finance_payment_plans audit_finance_plans; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER audit_finance_plans AFTER INSERT OR DELETE OR UPDATE ON public.finance_payment_plans FOR EACH ROW EXECUTE FUNCTION public.log_finance_changes();
...
--
-- Name: attendance_records attendance_records_schedule_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.attendance_records
    ADD CONSTRAINT attendance_records_schedule_id_fkey FOREIGN KEY (schedule_id) REFERENCES public.course_schedules(id);


--
-- Name: attendance_records attendance_records_staff_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: bulletins bulletins_academic_year_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.bulletins
    ADD CONSTRAINT bulletins_academic_year_id_fkey FOREIGN KEY (academic_year_id) REFERENCES public.academic_years(id);


--
-- Name: bulletins bulletins_semester_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.bulletins
    ADD CONSTRAINT bulletins_semester_id_fkey FOREIGN KEY (semester_id) REFERENCES public.semesters(id);


--
-- Name: bulletins bulletins_student_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.bulletins
    ADD CONSTRAINT bulletins_student_id_fkey FOREIGN KEY (student_id) REFERENCES public.students(id);


--
-- Name: classes classes_specialty_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.classes
    ADD CONSTRAINT classes_specialty_id_fkey FOREIGN KEY (specialty_id) REFERENCES public.specialties(id);
...
ALTER TABLE ONLY public.course_schedules
    ADD CONSTRAINT course_schedules_academic_year_id_fkey FOREIGN KEY (academic_year_id) REFERENCES public.academic_years(id);
...
ALTER TABLE ONLY public.course_schedules
    ADD CONSTRAINT course_schedules_class_id_fkey FOREIGN KEY (class_id) REFERENCES public.classes(id);


--
-- Name: course_schedules course_schedules_staff_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.course_schedules
    ADD CONSTRAINT course_schedules_staff_id_fkey FOREIGN KEY (staff_id) REFERENCES public.staff(id);
...
ALTER TABLE ONLY public.disciplinary_actions
    ADD CONSTRAINT disciplinary_actions_issued_by_fkey FOREIGN KEY (issued_by) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.disciplinary_actions
    ADD CONSTRAINT disciplinary_actions_student_id_fkey FOREIGN KEY (student_id) REFERENCES public.students(id);


--
-- Name: evaluations evaluations_academic_year_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.evaluations
    ADD CONSTRAINT evaluations_academic_year_id_fkey FOREIGN KEY (academic_year_id) REFERENCES public.academic_years(id);


--
-- Name: evaluations evaluations_semester_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.evaluations
    ADD CONSTRAINT evaluations_semester_id_fkey FOREIGN KEY (semester_id) REFERENCES public.semesters(id);


--
-- Name: evaluations evaluations_subject_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: finance_fee_types finance_fee_types_academic_year_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.finance_fee_types
    ADD CONSTRAINT finance_fee_types_academic_year_id_fkey FOREIGN KEY (academic_year_id) REFERENCES public.academic_years(id);


--
-- Name: finance_payment_plans finance_payment_plans_student_fee_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.finance_payment_plans
    ADD CONSTRAINT finance_payment_plans_student_fee_id_fkey FOREIGN KEY (student_fee_id) REFERENCES public.finance_student_fees(id);


--
-- Name: finance_payments finance_payments_recorded_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.finance_payments
    ADD CONSTRAINT finance_payments_recorded_by_fkey FOREIGN KEY (recorded_by) REFERENCES public.users(id);


--
-- Name: finance_payments finance_payments_student_fee_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.finance_payments
    ADD CONSTRAINT finance_payments_student_fee_id_fkey FOREIGN KEY (student_fee_id) REFERENCES public.finance_student_fees(id);


--
-- Name: finance_student_fees finance_student_fees_fee_type_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.finance_student_fees
    ADD CONSTRAINT finance_student_fees_fee_type_id_fkey FOREIGN KEY (fee_type_id) REFERENCES public.finance_fee_types(id);


--
-- Name: finance_student_fees finance_student_fees_student_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.finance_student_fees
    ADD CONSTRAINT finance_student_fees_student_id_fkey FOREIGN KEY (student_id) REFERENCES public.students(id);
...
--
-- Name: grades grades_evaluation_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: official_documents official_documents_student_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.official_documents
    ADD CONSTRAINT official_documents_student_id_fkey FOREIGN KEY (student_id) REFERENCES public.students(id);


--
-- Name: payroll_slips payroll_slips_staff_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.payroll_slips
    ADD CONSTRAINT payroll_slips_staff_id_fkey FOREIGN KEY (staff_id) REFERENCES public.staff(id);
...
ALTER TABLE ONLY public.semesters
    ADD CONSTRAINT semesters_academic_year_id_fkey FOREIGN KEY (academic_year_id) REFERENCES public.academic_years(id);


--
-- Name: specialties specialties_track_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: subjects subjects_specialty_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.subjects
    ADD CONSTRAINT subjects_specialty_id_fkey FOREIGN KEY (specialty_id) REFERENCES public.specialties(id);
...
--
-- Name: whatsapp_notifications whatsapp_notifications_staff_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.whatsapp_notifications
    ADD CONSTRAINT whatsapp_notifications_staff_id_fkey FOREIGN KEY (staff_id) REFERENCES public.staff(id);
...
\unrestrict es31BnoiGd11YeQfbTXY6UEq96qUMagdoP47eKOeehF4CqDLAe7fnvhQSx1bgtA
